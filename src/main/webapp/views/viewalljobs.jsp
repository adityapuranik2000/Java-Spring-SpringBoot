...
<%@ page import="com.src.JobFeed.model.JobData" %>
<%@ page import="com.src.JobFeed.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://www.google.com/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>

<ab:set var="jobsData" value="${jobsData}" />
